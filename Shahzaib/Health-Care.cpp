...
{
    {1, { Patient{"jhon mety", 34, true},  appointment{"2024-06-10", "Dr. Smith"   } } },
    {2, { Patient{"kim lee", 56,  false},  appointment{"2024-06-15", "Dr. Johnson" } } },
    {3, { Patient{"doren maj", 95, true},  appointment{"2024-06-20", "Dr. Brown"   } } },
    {4, { Patient{"Alice", 25,    false},  appointment{"2024-06-25", "Dr. Anderson"} } },
    {5, { Patient{"Bob", 30,       true},  appointment{"2024-06-30", "Dr. Martinez"} } },
    {6, { Patient{"Charlie", 40,   true},  appointment{"2024-07-05", "Dr. Wilson"  } } }
};
...
//--------------------------------------------------
    ...
    cout << "          |    New Patient Record    |\n\n\n\n";
        ...
        patient_appointment_data.insert({id+1,{tmp_obj,tmp_obj1}});
        cout << endl;
        // cout<<"ID: "<<id<<endl;
